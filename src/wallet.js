...
const privateKeyLocation = process.env.PRIVATE_KEY || ('wallet/' + p2pPort.toString() + '/private_key');
...
const initWallet = () => {
    ...
    if (!fs_1.existsSync('wallet/' + p2pPort.toString())) {
        fs_1.mkdirSync('wallet/' + p2pPort.toString());
    }
